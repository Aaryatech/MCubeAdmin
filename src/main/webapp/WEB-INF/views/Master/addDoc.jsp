					...
					<div class="col-md-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form
									action="${pageContext.request.contextPath}/showDocumentList"
									...
									<div class="form-group row">
										...
										<div class="col-lg-3">
											<input type="text" class="form-control  "
												placeholder="Document Name" id="fname" name="fname"
									...
									<div id="abc" style="display: none;">
										<div class="form-group row">
											<label class="col-form-label col-lg-2" for="leavingDate">Modified Date
												 : </label>
											<div class="col-lg-10">
