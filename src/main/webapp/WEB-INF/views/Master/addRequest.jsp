					...
					<div class="col-md-12">
						...
						<div class="card">
							...
							<div class="card-body">
								...
								<form
									action="${pageContext.request.contextPath}/dash"
									...
									<div class="form-group row">
										...
										<div class="col-lg-3">
											<input type="text" class="form-control  "
												...
												value="REQ21213" readonly="readonly" autocomplete="off"
									...
									<div class="form-group row">
										...
										<div class="col-lg-5">
											<select name="locId" data-placeholder="Select" id="locId"
												...
												<option selected="selected" value="1">Emp 1</option>

												<option value="1">Emp 2</option>
									...
									<div class="form-group row">
										...
										<div class="col-lg-5">
											<input type="text" class="form-control  "
												placeholder="Client Name" id="fname" name="fname"
									...
									<div class="form-group row">
										...
										<div class="col-lg-3">
											<input type="text" class="form-control  "
												placeholder="Deal Name" id="fname" name="fname"
												autocomplete="off" onchange="trim(this)"> <span
												class="validation-invalid-label" id="error_fname"
												style="display: none;">This field is required.</span>
										</div>
									...
									<div id="abc" style="display: none;">
										<div class="form-group row">
											<label class="col-form-label col-lg-2" for="leavingDate">
												Date : </label>
											<div class="col-lg-10">
									...
									<div class="form-group row mb-0">
										<div class="col-lg-10 ml-lg-auto">
											...
											<a href="${pageContext.request.contextPath}/dash"><button
