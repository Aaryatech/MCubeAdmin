...
var Dashboard = function () {
    ...
    // Dash Daily revenue line chart
    var _DashDailyRevenueLineChart = function(element, height) {
        if (typeof d3 == 'undefined') {
            console.warn('Warning - d3.min.js is not loaded.');
            return;
        }
    ...
    return {
        ...
        initCharts: function() {
            ...
            _DashDailyRevenueLineChart('#today-revenue-dash', 50);
            ...
            _BarChart('#dash-members-online', 24, 50, true, 'elastic', 1200, 50, 'rgba(255,255,255,0.5)', 'dash-members');
